			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						...
						<div class="card-body">
							<form method="post" id="sign_booker" action="./BookerDelete">
								<fieldset>
									...
									<div class="form-group">
										<button type="submit" class="btn btn-secondary">예매취소</button>
									</div>
								</fieldset>
							</form>
							<div class="row">
								<div class="col-md-4">
									<a href="./TicketSelect" class="btn btn-danger btn-block">
										메인페이지 </a>
								</div>
								<div class="col-md-4">
