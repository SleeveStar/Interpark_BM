			...
			<div class="card-body">
				<fieldset>
					<form action="./AddressUpdate" method="post" id="sign_address">
						<input type="hidden" name="num" id="num" value="${addressDTO.num}"
							readonly>
						<div>
							배송지 이름 : <input type="text" name="addressname" id="addressname">
						</div>
						<div>
							주소 : <input type="text" name="address" id="address">
						</div>
						<div>
							전화번호 : <input type="text" name="phone" id="phone" placeholder="-제외">
						</div>
						<div>
							<br>
