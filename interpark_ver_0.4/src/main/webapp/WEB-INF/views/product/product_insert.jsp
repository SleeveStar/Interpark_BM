...
<body>
	<header class="head">
		...
		<ul class="header-menu-list">
			...
			<li><a href="./product_insert"><span class="thispage">상품등록</span></a></li>
	...
	<div class="container">
		<P class="createhead">상품등록</P>
		<form action="./product_insert" method="post" id="createproduct" enctype="multipart/form-data">
			<fieldset>
				<div class="create-menu">
					<div class="create-number">
						<p class="create-number-write">상품번호</p>
						<input type="text" id="productnumber" name="productnumber"
							class="productnumber" maxlength="5" placeholder="  상품번호를 입력하세요">
					</div>
					<div class="create-name">
						<p class="create-name-write">상품명</p>
						<input type="text" id="productName" name="productName"
							class="productName" maxlength="50" placeholder="  상품명을 입력하세요">
					</div>
					...
					<div class="create-discountprice">
						<p class="create-discountprice-write">할인율</p>
						<input type="text" id="discountPrice" name="discountPrice"
							class="discountprice" maxlength="20" placeholder="  배송비를 입력하세요">
					</div>
				</div>
				<div class="inputArea">
				...
				<div class="submit-reset">
					<input type="submit" id="psub" class="create-butten"> 
					<input type="reset" class="reset-butten">
				</div>
			</fieldset>
		</form>
	</div>
